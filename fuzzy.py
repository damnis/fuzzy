...
# Spelbeurt
    ...
    # 👉 Plan latere gevolgactie indien van toepassing
    if is_special and vraag.get("type_uitgesteld") and vraag.get("toon_actie_knop", False):
        if st.button("🚀 Actie", key=f"gevolg_btn_{vraag.get('uid', '')}"):
            plan_gevolg(vraag)
